...
#define WORD_SZ sizeof(void*)               // Architecture's word sz (bytes)
...
#define MIN_BLOCK_SZ (BLOCK_HEAD_SZ + WORD_SZ)  // Min memory block size
...
void block_tofree(BlockHead *block) {
    // If free list empty
...
void block_rmfree(BlockHead *block) {
